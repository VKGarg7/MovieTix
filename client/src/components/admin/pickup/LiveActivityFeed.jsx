...
import { CheckCircle2Icon, RadioIcon } from "lucide-react";
...
const LiveActivityFeed = ({ events }) => (
  <div className="glass-panel !rounded-2xl p-4">
    ...
    {events.length === 0 ? (
      <p className="text-xs text-gray-500">No activity yet this session.</p>
    ) : (
      <div className="space-y-2 max-h-64 overflow-y-auto no-scrollbar">
        <AnimatePresence initial={false}>
          {events.map((e) => (
            ...
            >
              <CheckCircle2Icon className="w-3.5 h-3.5 text-nebula-cyan shrink-0 mt-0.5" />
